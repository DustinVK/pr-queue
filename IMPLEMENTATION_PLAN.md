...
The completed implementation is being submitted as eight dependent PRs: foundation, observation, runner, triage, publication preview, publication recovery, notifications, and CLI integration. This submission order keeps each commit buildable; the executable is wired in the final PR. The final PR also supplies the completed phase review log and validation records.
